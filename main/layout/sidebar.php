<section>
    ...
    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'dashboard.php') !== false) {
                ...
                <?php if ($_SESSION['role'] == 'Student' || $_SESSION['role'] == 'Parent') {
                    $attendancesLabel = ($_SESSION['role'] == 'Parent') ? 'My Child\'s Attendances' : 'My Attendances';
                    $subjectsLabel = ($_SESSION['role'] == 'Parent') ? 'My Child\'s Subjects' : 'My Subjects';
                ?>
                    ...
                    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'my-attendances.php') !== false  ) {
                        ...
                        <a href="my-attendances.php">
                            <img src="../images/icon/Lesson Icon.png" width="30px" height="30px">
                            <span><?php echo $attendancesLabel; ?></span>
                        </a>
                    </li>

                    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'my-subjects.php') !== false  ) {
                        echo "active";
                    } ?>">
                        <a href="my-subjects.php">
                            <img src="../images/icon/Lesson Icon.png" width="30px" height="30px">
                            <span><?php echo $subjectsLabel; ?></span>
                        </a>
                    </li>
