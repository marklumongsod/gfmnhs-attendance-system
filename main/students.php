                ...
                <form action="models/CRUDS.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input name="studNo" type="text"  class="form-control" value="<?= $row['studNo']; ?>"
                                       minlength="12" maxlength="12"  title="LRN max number is 12 " oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  
                                    required>
                                    <label class="form-label">LRN</label>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input name="contact" type="text" class="form-control" value="<?= $row['contact']; ?>" 
