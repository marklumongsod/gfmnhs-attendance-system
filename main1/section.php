...
<section class="content">
  ...
  <div class="body">
   ...
   <tbody> 
     ...
     <?php  $result = my_query("SELECT *  FROM tbl_section   ");   
    ...
    <div class="modal-content">
      ...
      <form action="models/CRUDS.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          <button type="submit" value="IUSection" name="func_param" class="btn btn-primary waves-effect">SAVE</button>
...
<!-- Edit -->
<?php   
$result = my_query("SELECT *  FROM tbl_section s WHERE section<>'' GROUP BY section");
  ...
  <div class="modal fade" id="edit<?=$id; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog  modal-smd" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" value="IUSection" name="func_param" class="btn btn-warning waves-effect">UPDATE</button>
          <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">CLOSE</button>
        </div>
      </form>
    </div>
       ...
       <div class="col-md-12" style="text-align: center;">    
        <h4>Are you sure you want to
          delete  <br/> (<i><b>
            ...
            asd" type="button"  data-toggle="modal" data-target="#edit<?=$id; ?>" style="color: red" id="removeNo"> <?=$row['section']; ?></a></b></i> ) information?  <br/>There is NO undo! </h4>
          </div>   
        </div>
        <div class="modal-footer">
          <button type="submit" value="deleteSection" name="func_param" class="btn btn-danger waves-effect">DELETE</button>
          <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">CLOSE</button>
        </div>
      </form>
    </div>
