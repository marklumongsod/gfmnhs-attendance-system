                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    $result = my_query("SELECT *,CONCAT(lname,',',fname,' ',LEFT(mname,1),'.')fullname ,CONCAT(email,'</br>',contact,'</br>',address)profile   FROM tbl_students   ORDER BY id DESC");
                ...
                <form action="models/CRUDS.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input name="studNo" maxlength="12" type="text" class="form-control" required>
                ...
                <form action="models/CRUDS.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input name="studNo" type="text" maxlength="40" class="form-control" value="<?= $row['studNo']; ?>" required>
                                    <label class="form-label">Student #</label>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="delete<?= $id; ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog  modal-smd" role="document">
            ...
            asd" type="button" data-toggle="modal" data-target="#edit<?= $id; ?>" style="color: red"
                                           id="removeNo"> <?= $row['studNo'] . '-' . $row['fname']; ?>
                                        </a>
                                    </b>
                                </i> )
