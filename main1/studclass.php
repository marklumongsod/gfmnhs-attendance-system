                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    $result = my_query("SELECT *,CONCAT(fname,' ',lname)student ,cc.id id FROM tbl_classstudent cc INNER JOIN tbl_students u ON u.id=cc.studId INNER JOIN tbl_class c ON cc.classId=c.id WHERE classId='$classId' ORDER BY cc.id DESC");
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-float">
                           ...
                           <select name="studId" class="form-control select" required>
                                    <option></option>
                                    <?php $classId = $_GET['classId'];
                                    $res = my_query("SELECT CONCAT(fname,' ',lname)student,tbl_students.id as sid FROM tbl_students WHERE id NOT IN(SELECT studId FROM tbl_classstudent WHERE classId='$classId')");
