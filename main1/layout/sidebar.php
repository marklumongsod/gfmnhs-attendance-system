<section>
    ...
    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'dashboard.php') !== false) {
                ...
                <?php if ($_SESSION['role'] == 'Admin') { ?>
                    ...
                    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'class.php') !== false) {
                        echo "active";
                    } ?>">
                        <a href="class.php">
                ...
                <?php if ($_SESSION['role'] == 'Student') { ?>
                    ...
                    <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'lessons.php') !== false || strpos($_SERVER['REQUEST_URI'], 'view.php?cat=Lesson') !== false) {
                        echo "active";
                    } ?>">
                ...
                <li class="<?php if (strpos($_SERVER['REQUEST_URI'], 'dashboards.php') !== false || strpos($_SERVER['REQUEST_URI'], 'games.php') !== false) {
                    echo "active";
                } ?>">
                    <a href="logout.php">
